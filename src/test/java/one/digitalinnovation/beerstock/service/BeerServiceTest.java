...
public class BeerServiceTest {
    ...
    @Test
    void whenAlreadyRegisteredBeerInformedAnExceptionShouldBeThrown() {
        //given
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenNotRegisteredBeerNameIdGivenThenThrowAnException() {
        //given
        BeerDTO expectedFoundBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenIncrementIsHigherThanMaxThenThrowException() {
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
    ...
    @Test
    void whenIncrementAfterSumIsHigherThanMaxThenThrowException() {
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
    ...
    void whenIncrementIsCalledWithInvalidIdThenThrowException() {
        ...
        assertThrows(BeerNotFoundException.class, () -> beerService.increment(INVALID_BEER_ID,
                quantityToIncrement));
    }

//    @Test
//    void whenIncrementIsCalledToEmptyStockThenEmptyBeerStock() throws BeerNotFoundException, BeerStockExceededException {
//        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
//        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
//
//        when(beerRepository.findById(expectedBeerDTO.getId())).thenReturn(Optional.of(expectedBeer));
...
//
//        assertThat(expectedQuantityAfterIncrement, equalTo(0));
//        assertThat(expectedQuantityAfterIncrement, equalTo(incrementedBeerDTO.getQuantity()));
//    }
//
